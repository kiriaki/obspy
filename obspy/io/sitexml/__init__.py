...
Tests With Bundled Examples
-----------------------------------

The ``sitexml`` package ships with XML, CSV, and Excel examples under
...
Import bundled CSV files and inspect one imported site:
...
Apply optional quality-index inputs during CSV import. The QI input
...
Apply quality-index inputs later to an existing dictionary, for
